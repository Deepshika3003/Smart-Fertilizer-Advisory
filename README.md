...
Smallholder farmers in Telangana heavily over-apply 
Nitrogen based fertilizers like Urea due to biased 
dealer recommendations and lack of soil testing access. 
This leads to severe NPK imbalance, soil degradation 
...
5. System shows fertilizer recommendation with dosage
6. NPK balance status and cost saving tip displayed

---

## Technology Used
- Python + TensorFlow + MobileNetV2 (AI Model)
- Flask (Backend)
